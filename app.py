...
Create an Opportunities report in your CRM. Use **Tabular** format and include the following fields, in this exact order:  
Opportunity ID, Opportunity Name, Account ID, Amount, Type, Stage, Created Date, Closed Date, and Opportunity Owner.

- Go to Reports → New Report → Opportunities (or equivalent)
- Switch to Tabular
- Add fields in the exact order above
- Filters:
  - Show Me / Scope: All Opportunities
...
Create an Opportunities with Contact Roles report (or equivalent). Use Tabular format and include these fields, exactly in this order:  
Opportunity ID, Opportunity Name, Account ID, Amount, Type, Stage, Opportunity Created Date, Opportunity Closed Date, Opportunity Owner, Contact ID, Title, Department, Role, and Is Primary.

- New Report → Opportunities with Contact Roles
- Tabular → add fields in the exact order above
...
st.markdown("Upload two CRM exports: **Opportunities** and **Opportunities with Contact Roles**.")
...
if opps_file and roles_file:
    ...
    st.caption("Map your CRM stages into Early, Mid, Late, Won, and Lost buckets so stage gates apply correctly.")
    ...
    st.caption("Red-flag check: Won deals should never have zero contact roles.")
    st.altair_chart(
