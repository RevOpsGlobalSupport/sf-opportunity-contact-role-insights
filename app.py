...
if opps_file and roles_file:
    ...
    <html>
      ...
      <body style="font-family: Arial, sans-serif; padding:16px;">
        <h2>Salesforce Opportunity Contact Role Insights</h2>
        <p><b>Total Opportunities:</b> {total_opps:,}</p>
        <p><b>Total Pipeline:</b> ${total_pipeline:,.0f}</p>
        <p><b>Current Win Rate:</b> {win_rate:.1%}</p>
    ...
    st.download_button(
        ...
        file_name="RevOps_Global_Contact_Role_Insights_Report.html",
        mime="text/html"
    )
    section_end()
